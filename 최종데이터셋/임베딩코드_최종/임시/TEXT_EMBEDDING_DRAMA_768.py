"""
Drama Overview + Genre 텍스트 임베딩 코드
sentence-transformers/all-mpnet-base-v2 모델 사용
"""
...
print(f"drama_genres_final shape: {drama_genres_final.shape}")
...
# 예: tt0412175 -> "Crime, Drama, Mystery, Sci-Fi & Fantasy"
...
# drama_final과 genres_grouped 병합
merged_df = drama_final.merge(genres_grouped, on='imdb_id', how='left')
...
intermediate_csv_path = "최종데이터셋_드라마/drama_combined_text_intermediate.csv"
...
# =====================================================
print("\n" + "=" * 50)
print("5. sentence-transformers/all-mpnet-base-v2 모델 로드")
print("=" * 50)
...
final_parquet_path = "최종데이터셋_드라마/drama_with_embeddings_768.parquet"
